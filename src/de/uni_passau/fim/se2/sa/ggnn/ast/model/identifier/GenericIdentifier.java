...
public record GenericIdentifier(SimpleIdentifier identifier, List<TypeArgument> typeArguments)
    implements Identifier, Visitable, ClassOrInterfaceType, MaybeGenericIdentifier {
