...
public interface JavaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#genericIdentifier}.
	 * @param ctx the parse tree
	 */
	void enterGenericIdentifier(JavaParser.GenericIdentifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#genericIdentifier}.
	 * @param ctx the parse tree
	 */
	void exitGenericIdentifier(JavaParser.GenericIdentifierContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#createdNameIdentifier}.
	 * @param ctx the parse tree
	 */
	void enterCreatedNameIdentifier(JavaParser.CreatedNameIdentifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#createdNameIdentifier}.
	 * @param ctx the parse tree
	 */
	void exitCreatedNameIdentifier(JavaParser.CreatedNameIdentifierContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#annotatedBrackets}.
	 * @param ctx the parse tree
	 */
	void enterAnnotatedBrackets(JavaParser.AnnotatedBracketsContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#annotatedBrackets}.
	 * @param ctx the parse tree
	 */
	void exitAnnotatedBrackets(JavaParser.AnnotatedBracketsContext ctx);
	/**
