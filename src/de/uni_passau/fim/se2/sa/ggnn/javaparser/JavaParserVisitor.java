...
public interface JavaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#genericIdentifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGenericIdentifier(JavaParser.GenericIdentifierContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#createdNameIdentifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCreatedNameIdentifier(JavaParser.CreatedNameIdentifierContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#annotatedBrackets}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnnotatedBrackets(JavaParser.AnnotatedBracketsContext ctx);
	/**
